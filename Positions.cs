    ...
    public partial class Positions : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                For.InsertCommand = new SqlCommand("ADD_Posit", connection);
                For.InsertCommand.CommandType = CommandType.StoredProcedure;
                For.InsertCommand.Parameters.Add(new SqlParameter("@name_position", SqlDbType.VarChar, 40, "name_position"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@salary", SqlDbType.VarChar, 30, "salary"));
        ...
        {
            openchild(panel1, new Positions());
        }
