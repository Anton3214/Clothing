    ...
    public partial class Clothing : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                For.InsertCommand = new SqlCommand("ADD_Clot", connection);
                For.InsertCommand.CommandType = CommandType.StoredProcedure;
                For.InsertCommand.Parameters.Add(new SqlParameter("@name_clothing", SqlDbType.VarChar, 50, "name_clothing"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_type", SqlDbType.Int, 0, "id_type"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_sex", SqlDbType.Int, 0, "id_sex"));
                For.InsertCommand.Parameters.Add(new SqlParameter("@id_season", SqlDbType.VarChar, 10, "id_season"));
